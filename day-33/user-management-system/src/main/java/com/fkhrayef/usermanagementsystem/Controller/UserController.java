package com.fkhrayef.usermanagementsystem.Controller;

import com.fkhrayef.usermanagementsystem.Api.ApiResponse;
import com.fkhrayef.usermanagementsystem.Model.User;
import com.fkhrayef.usermanagementsystem.Service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<?> getUsersOlderThanAge(@PathVariable("age") Integer age) {
        return ResponseEntity.status(HttpStatus.OK).body(userService.getUsersOlderThanAge(age));
    }
}
